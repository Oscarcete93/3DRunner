...
public class CountDownScript : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        wall5.GetComponent<GroundControl>().enabled = false;
        wall6.GetComponent<GroundControl>().enabled = false;
    ...
    IEnumerator CountdownFunction()
    {
        ...
        wall5.GetComponent<GroundControl>().enabled = true;
        wall6.GetComponent<GroundControl>().enabled = true;
